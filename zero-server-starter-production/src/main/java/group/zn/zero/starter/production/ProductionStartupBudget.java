 ...
 * @author zn
 */
final class ProductionStartupBudget {
     ...
     */
    ProductionStartupBudget(final Duration totalBudget, final Duration adapterBudget) {
        this(totalBudget, adapterBudget, System::nanoTime);
    }

    /** 包级测试构造器。 */
    ProductionStartupBudget(
     ...
     */
    Duration remainingFor(final String adapterName) {
