 ...
 * @author zn
 */
public record ConnectionAttributeKey<T>(String name, Class<T> valueType) {
     ...
     */
    public static <T> ConnectionAttributeKey<T> of(final String name, final Class<T> valueType) {
        return new ConnectionAttributeKey<>(name, valueType);
    }
