 ...
 * @author zn
 */
public final class DefaultConnectionAttributes implements ConnectionAttributes {

    /**
     * 属性表。
     */
    private final Map<ConnectionAttributeKey<?>, Object> values = new ConcurrentHashMap<>();
     ...
     */
    @Override
    public <T> Optional<T> get(final ConnectionAttributeKey<T> key) {
     ...
     */
    @Override
    public <T> Optional<T> put(final ConnectionAttributeKey<T> key, final T value) {
        Objects.requireNonNull(key, "key");
     ...
     */
    @Override
    public <T> Optional<T> remove(final ConnectionAttributeKey<T> key) {
        Objects.requireNonNull(key, "key");
     ...
     */
    @Override
    public <T> Optional<T> update(final ConnectionAttributeKey<T> key, final Function<T, T> updater) {
        Objects.requireNonNull(key, "key");
