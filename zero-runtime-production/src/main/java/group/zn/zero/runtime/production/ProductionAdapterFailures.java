 ...
 * @author zn
 */
public final class ProductionAdapterFailures {
     ...
     */
    public static ProductionAdapterException failure(
     ...
     */
    public static ProductionAdapterException sanitize(
            final String adapterName,
            final ProductionAdapterFailurePhase phase,
            final ErrorCode errorCode,
            final String safeMessage,
     ...
     */
    public static ProductionAdapterException reclassify(
            final String adapterName,
            final ProductionAdapterFailurePhase phase,
            final ErrorCode errorCode,
            final String safeMessage,
     ...
     * @return 安全异常；不可为空。
     */
    public static ProductionAdapterException missingConfig(final List<String> missingKeys) {
     ...
     * @return 安全异常；不可为空。
     */
    public static ProductionAdapterException invalidConfig(
            final String adapterName,
            final ProductionAdapterFailurePhase phase,
            final String key) {
        return failure(
