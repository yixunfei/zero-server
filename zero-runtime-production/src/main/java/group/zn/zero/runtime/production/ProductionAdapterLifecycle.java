 ...
 * @author zn
 */
public final class ProductionAdapterLifecycle extends AbstractLifecycle {
     ...
     */
    public ProductionAdapterLifecycle(
     ...
     */
    public static ProductionAdapterLifecycle marker(
            final ProductionAdapterDiagnostic diagnostic,
            final ProductionStartupBudget startupBudget) {
